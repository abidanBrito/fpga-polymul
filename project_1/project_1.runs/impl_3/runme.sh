...
HD_PWD='/home/jharing/git/2nd/chw2022g3/project_1/project_1.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log cryptoprocessor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cryptoprocessor_wrapper.tcl -notrace
