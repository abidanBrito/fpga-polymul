...
HD_PWD='/home/jharing/git/2nd/chw2022g3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cryptoprocessor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cryptoprocessor_wrapper.tcl
